...
- Balanced action-risk training is separate from IQL promotion. It exists to calibrate `P(large loss | visible state, action)` before any serving-time guard is considered.
