...
- **rlpaipu/** — Debug CLI that plays a deterministic heuristic round through `engine.Game` with `PaipuRecorder` attached and writes replay-viewer-compatible paipu JSON.
