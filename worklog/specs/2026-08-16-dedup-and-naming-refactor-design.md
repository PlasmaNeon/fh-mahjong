...
| A rename breaks a runbook, Dockerfile, or CI reference | Verifiers counted referrers per proposal, including `worklog/*`, `Makefile`, `Dockerfile*`, `.github/workflows`, and `ai/pyproject.toml` scripts; every referrer is updated in the same PR |
