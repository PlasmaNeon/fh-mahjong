...
**Spec:** `worklog/specs/2026-07-16-spec-b2b-training-design.md` (approved). Branch: `claude/spec-b2b-training` (exists, off main @ ae29337).
...
- Create: `worklog/plans/2026-07-16-spec-b2b-runbook.md` (the §6 run protocol as an operational checklist)

- [ ] **Step 1: Write the runbook**

Create `worklog/plans/2026-07-16-spec-b2b-runbook.md`:
...
```bash
git add ai/AGENTS.md worklog/plans/2026-07-16-spec-b2b-runbook.md
