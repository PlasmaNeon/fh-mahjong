...
- **paipu.go** — Structured paipu recording support:
  ...
  - **Paipu v2 (2026-08-09, `docs/superpowers/specs/2026-08-09-paipu-v2-provenance-design.md`)** — `PaipuVersion = 2` (bump-guarded) added two things on top of the unchanged v1 `Actions` replay stream:
