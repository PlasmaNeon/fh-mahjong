...
**Spec:** `docs/superpowers/specs/2026-07-20-spec-b2c-serving-design.md` (approved by user + Codex, corrections 1-4 folded in). Branch: `claude/spec-b2c-serving` (exists, off main @ 85273ab).
...
- Create: `docs/superpowers/plans/2026-07-20-spec-b2c-runbook.md`
