...
**Spec:** `docs/superpowers/specs/2026-08-09-paipu-v2-provenance-design.md` — read it first.
...
- Modify: `docs/superpowers/specs/2026-08-09-paipu-v2-provenance-design.md` (mark shipped status if desired — optional)
