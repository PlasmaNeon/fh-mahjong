...
- **src/** — Application source code (pages, components, contexts, hooks, utils, proto bindings). `src/components/` holds the shared "Tabletop Glass" theme primitives used by every non-game page.
