...
- **src/** — Application source code (pages, theme, contexts, hooks, utils, proto bindings). `src/i18n/` owns device-locale detection plus English and Simplified Chinese resources. `src/theme/` is the shared Rainy Mahjong Club theme module and the single ordered CSS import surface; `src/table/table-theme.css` layers table materials over the unchanged fixed-stage geometry. See `src/theme/AGENTS.md`.
