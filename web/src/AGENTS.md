...
- **index.css** — Global reset and fixed-stage geometry (TailwindCSS + table layout); Rainy Club visual values live under `theme/` and `table/table-theme.css`
  ...
  - Compact short-stage geometry gives the local hand a 76x107 design-pixel tile rail (about 42x59 CSS pixels at 667x375), keeps the drawn tile separated, and leaves opponent/discard tile sizes unchanged
