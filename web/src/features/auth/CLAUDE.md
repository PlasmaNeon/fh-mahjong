...
- **authModal.ts** — Shared route-state and optional-versus-required login presentation rules (`AuthRouteState`, `resolveAuthDialogMode`).
...
- **authClient.test.ts** / **authModal.test.ts** / **AuthDialog.test.ts** — Unit coverage for the helpers and dialog behavior.
